...
async function create(params) {
  // validate
  // if (await db.Application.findOne({ where: { unit_id: params.unit_id } })) {
  //     throw 'Unit Number "' + params.unit_id + '" is already taken';
  // }
...
async function update(id, params) {
  ...
  if (
    unitNoChanged &&
    (await db.Unit.findOne({ where: { unit_no: params.unit_no } }))
  ) {
